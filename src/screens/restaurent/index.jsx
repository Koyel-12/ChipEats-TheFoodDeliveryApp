      ...
      days.map((val) => (
          <View>
              ...
              <View style={styles.row2}>
                  <Text style={styles.subText}>{val.day}</Text>
                  <Text style={styles.subText} >{val.time}</Text>
              </View>
          </View>
      ))
  )
       ...
       <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
            <View styles={styles.top}>
                ...
                <View style={styles.row}>
                    ...
                    <Text styles={styles.subText}>{data.review_count} reviews</Text>
                </View>
            </View>
            <View style={styles.line}/>
              <View style={styles.row2}>
                  <View style={styles.row}>
                    <TouchableOpacity onPress={()=>{setFav(!fav);}} style={styles.icon}>
